"""
Question 6: Generate synthetic noisy images using different noise models (e.g., Gaussian, salt-and-pepper).
Implement mean filters, median filters, and adaptive filters for noise reduction.
"""
